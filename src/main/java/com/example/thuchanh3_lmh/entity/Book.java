package com.example.thuchanh3_lmh.entity;

import com.example.thuchanh3_lmh.validator.annotation.ValidCategoryId;
import com.example.thuchanh3_lmh.validator.annotation.ValidUserId;
...
public class Book {
    ...
    @Size(max = 50, min = 1, message = "Title mist be less than 50 characters")
